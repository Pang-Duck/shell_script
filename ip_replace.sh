...
SERVER_IP_CONFIG_PATH=(
   ...
   "${ROOT}/hotdata/dti/data_node/data/click/metadata/dti/*"
   "${ROOT}/hotdata/dti/data_node/data/click1/metadata/dti/*"
   "${ROOT}/hotdata/dti/data_node/data/click2/metadata/dti/*"
   "${ROOT}/hotdata/dti/data_node/data/click3/metadata/dti/*"
)
